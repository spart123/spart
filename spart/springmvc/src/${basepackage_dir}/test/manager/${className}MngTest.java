...
package ${basepackage}.test.manager;
...
import ${basepackage}.manager.UserInfoMng;
<#include "/java_imports.include">

public class ${className}MngTest extends BaseManagerTestCase{

	private ${className}Mng manager;
	
	@Autowired
	public void set${className}Manager(${className}Mng manager) {
