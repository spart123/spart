	...
	public static SessionFactory readXmlWebRootForContext() {
		BeanFactory beanFactory = new FileSystemXmlApplicationContext(
				new String[] { "WebRoot/WEB-INF/config/applicationcontext.xml", 
						"WebRoot/WEB-INF/config/cache-context.xml","WebRoot/WEB-INF/config/captcha-context.xml", 
						"WebRoot/WEB-INF/config/jeecms-context.xml","WebRoot/WEB-INF/config/jeecms-servlet-admin-action.xml", 
						"WebRoot/WEB-INF/config/jeecms-servlet-admin.xml","WebRoot/WEB-INF/config/jeecms-servlet-front-action.xml",
						"WebRoot/WEB-INF/config/jeecms-servlet-front.xml","WebRoot/WEB-INF/config/jeecore-context.xml" });
