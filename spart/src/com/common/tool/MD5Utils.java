...
public class MD5Utils {
	...
	public static String getSimenMD5(String strSrc) {
		...
		str2.append(str1.substring(0, 2)).append("|").append(
				str1.substring(4, 10)).append("|")
				.append(str1.substring(8, 21)).append("|").append(
						str1.substring(14, 19)).append("|").append(
						str1.substring(1, 9)).append("|").append(
						str1.substring(24, 27));
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(getSimenMD5("dddd").toLowerCase());
	}
}
